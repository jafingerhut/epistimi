...
do not cancel.  We will use $F$ to denote the difference of those
radicals for the moment.
\begin{align}
e_{3,E}-e_{2,E}
  & = q_3 - q_2 + \frac{\gamma_S^2}{c^2} ( Z_{-}v_S - Z_{+}v_S ) + \frac{\gamma_S^2}{c^2} F \nonumber \\
  & = q_3 - q_2 - \frac{\gamma_S^2}{c^2} ( \frac{Lv_S}{\gamma_S} ) + \frac{\gamma_S^2}{c^2} F \nonumber \\
  & = (e_{3,B}-e_{2,B}) + \frac{\gamma_S^2}{c^2} F \nonumber
\end{align}
...
\begin{align*}
F
  & = \frac{c}{\gamma_S} \left[ |Z_{-}| \sqrt{ \gamma_S^2 + (D/Z_{-})^2 } - |Z_{+}| \sqrt{ \gamma_S^2 + (D/Z_{+})^2 } \right]
\end{align*}
...
\end{align*}
then $F = \frac{c}{\gamma_S} (a-b)$.  Focusing on the $a-b$ part, we
...
\begin{align*}
F
  & = (\frac{c}{\gamma_S}) \frac{a^2-b^2}{a+b} \\
  & = (\frac{c}{\gamma_S}) \frac{-2LZ\gamma_S}{|Z_{-}| \sqrt{ \gamma_S^2 + (D/Z_{-})^2 } + |Z_{+}| \sqrt{ \gamma_S^2 + (D/Z_{+})^2 }} \\
  & = \frac{-2LZc}{|Z_{-}| \sqrt{ \gamma_S^2 + (D/Z_{-})^2 } + |Z_{+}| \sqrt{ \gamma_S^2 + (D/Z_{+})^2 }} \\
\end{align*}
