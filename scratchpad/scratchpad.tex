...
\end{itemize}
could be said in much more detail as:
\begin{itemize}
\item $A$, in accordance with special relativity's time
  synchronization convention that light propagates in $A$'s inertial
  frame isotropically with one-way speed $c$, $A$ deduces that $B$'s
  clock runs slower than $A$'s.
\end{itemize}
