...
\begin{equation}
F = \sqrt{ |\vect{v}_C - \vect{v}_B|^2 - \frac{v_C^2 v_B^2 \sin^2 \theta}{c^2} }
\end{equation}
So the above expression under the radical becomes $c^2 F^2$,
and the entire Equation~\eqref{eqn:scen1c-TC} can be written:
\begin{align}
T_C
  & = \frac{\gamma_B}{\gamma_C} T_B \left[ 1 + \frac{\gamma_C^2}{c^2} \left( (v_C^2 - \vect{v}_B \cdot \vect{v}_C) + cF \right) \right] \nonumber \\
\frac{T_C}{T_B}
