...
\begin{lemma}
  If a transformation from intertial frame $S$ to frame $S'$,
  specified as a function from events $(t, x)$ to $(t', x')$, must
  satisfy the constraints of \erp, \esol, \homogeneity, \linearity,
...
Plug equations for $x'$, $t'$ into $Q'(x,t)$ to get:
\begin{align}
Q'(x,t)
  & = c^2 (Dx + Et)^2 - (Ax+Bt)^2 \nonumber \\
