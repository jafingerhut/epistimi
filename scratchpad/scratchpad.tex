...
e_3 - e_2
  ...
  & = \frac{L}{c} \left[ \frac{1}{\beta}(1-\frac{1}{\gamma}) - \beta \gamma \right] & & \text{algebra} \label{eqn:Bdeltatime3minus2}
\end{align}
...
% use the Lemma if you now vectors r_0 and v, but not the angle theta
% between them.
