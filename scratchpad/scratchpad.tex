...
By Corollary~\ref{cor:magVplusC}, the magnitude of $\vect{v} \oplus
...
|\vect{v} \oplus \vect{u}|^2
  ...
  & = \frac{1}{K^2} \left[ (v + u \cos \theta)^2 + \frac{u^2 \sin^2 \theta}{\gamma^2} \right] & & \text{$|\vect{u}_{\parallel}| = u \cos \theta$, $|\vect{u}_{\perp}| = u \sin \theta$} \label{eqn:lemmavplusupart1}
\end{align}
...
\begin{align*}
\cos \phi
  & = \frac{ \frac{v}{K} (v + u \cos \theta) }{ v \sqrt{ \frac{1}{K^2} \left[ (v + u \cos \theta)^2 + \frac{u^2 \sin^2 \theta}{\gamma^2} \right] } } \\
...
\begin{corollary}
\label{cor:magVplusC}
Given non-0 vectors $\vect{v}$ and $\vect{u}$ with $|\vect{u}|=c$,
$|\vect{v} \oplus \vect{u}|=c$.
\end{corollary}

\begin{proof}
\begin{align*}
|\vect{v} \oplus \vect{u}|^2
  & = \frac{1}{K^2} \left[ (v + u \cos \theta)^2 + \frac{u^2 \sin^2 \theta}{\gamma^2} \right] & & \text{Eqn.\eqref{eqn:lemmavplusupart1}} \\
  & = \frac{1}{K^2} \left[ (v + c \cos \theta)^2 + c^2 \sin^2 \theta (1 - v^2/c^2) \right] & & \text{defn. of $\gamma$, $|\vect{u}|=c$} \\
  & = \frac{c^2}{K^2} \left[ (\beta + \cos \theta)^2 + \sin^2 \theta (1 - \beta^2) \right] & & \text{algebra, $\beta = v/c$} \\
  & = \frac{c^2}{K^2} \left[ \beta^2 + 2 \beta \cos \theta + \cos^2 \theta + \sin^2 \theta - \beta^2 \sin^2 \theta \right] & & \text{algebra} \\
  & = \frac{c^2}{K^2} \left[ \beta^2 \cos^2 \theta + 2 \beta \cos \theta + 1 \right] & & \text{algebra} \\
  & = \frac{c^2}{K^2} \left[ \beta \cos \theta + 1 \right]^2 & & \text{algebra} \\
  & = \frac{c^2}{(1+\frac{vc \cos \theta}{c^2})^2} \left[ \beta \cos \theta + 1 \right]^2 & & \text{defn. of $K$} \\
  & = \frac{c^2}{(1+\beta \cos \theta)^2} \left[ \beta \cos \theta + 1 \right]^2 & & \text{defn. of $K$} \\
  & = c^2
\end{align*}
\end{proof}
