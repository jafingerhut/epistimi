...
other in a straight line, then according to special relativity, and
also according to Lorentz Ether Theory:
...
\item Both theories predict the same measurements in a simple
  ...
  $D$ always looks like a Doppler factor for some velocity $v$ that
  is, if not precisely the relative velocity of the sender and
  receiver, seems very strongly related to such a quantity.

\item If we adopt Lorentz Ether Theory, but remain ignorant of how to
