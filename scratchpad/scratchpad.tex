...
length.  Rod $S$ is moving left to right with velocity $v$ ($0 < v <
c$) relative to relative to $R$.  There is another person $B$ at rest
...
Each of these events causes a radio pulse to be emitted from the left
