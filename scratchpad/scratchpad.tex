...
$a \oplus (b \ominus a) = b$ & yes & yes
\\ \cline{1-3}
$|a \oplus b|=|b \oplus a|$ & yes & yes (Lemma~\ref{lem:magnitudeRelVecPlus2})
\\ \cline{1-3}
$|a \ominus b|=|b \ominus a|$ & yes & yes (Lemma~\ref{lem:magnitudeRelVecMinus})
\\ \cline{1-3}
...
\begin{lemma}
\label{lem:magnitudeRelVecPlus2}
...
\begin{lemma}
\label{lem:magnitudeRelVecMinus}
Given vectors $\vect{u}$ and $\vect{v}$:
\begin{equation}
...
\begin{proof}
We omit the details of the proof, as they are nearly identical
to the ones proving Equation~\eqref{eqn:lemmavplusupart3} in
Lemma~\ref{lem:magnitudeRelVecPlus1}.
\end{proof}
...
|\vect{v} \oplus \vect{u}|
  ...
  & = c
\end{align*}
By Lemma~\ref{lem:magnitudeRelVecPlus2}, we must also get the same
