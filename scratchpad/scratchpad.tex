...
Figure~\ref{fig:diagonal-length-contraction} shows the initial
...
\vect{r}_0^2 & = R^2 + D^2 & & \text{$\vect{R} \cdot \vect{D} = 0$} \\
...
\vect{r}_0^2 & = ((w_S-w_R)\hatvec{i} + \vect{R})^2 + D^2 & & \text{$\vect{R} \cdot \vect{D} = 0$} \\
