...
position $\vect{s} + \vect{r}$ at time $t_0$, where
$\vect{r} = (x_0,y_0)$.
...
The position of $O$ at time $t$ is given by:
\begin{equation}
x_O(t) = s_x + x_0 + v(t-t_0), y_0(t)=s_y + y_0
\end{equation}
This is simply a slight generalization of
Lemma~\ref{lem:IntersectingSpreadingPulse2}, but with the light pulse
starting point translated from the origin to $\vect{s}$, and the pulse
being transmitted at a translated time $t_0$ instead of 0.
